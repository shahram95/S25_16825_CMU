...
def colours_from_spherical_harmonics(spherical_harmonics, gaussian_dirs):
    ...
    """
    ### YOUR CODE HERE ###
    # Define the spherical harmonics constants
    SH_C0 = 0.28209479177387814
    ...
    # Initialize with the constant (zeroth order) term
    c0 = spherical_harmonics[:, :3]
    colours = SH_C0 * c0
    
    # First order terms (degree 1)
    ...
    # Add bias and clamp values
    colours = colours + 0.5
    return torch.clamp(colours, 0.0, 1.0)
